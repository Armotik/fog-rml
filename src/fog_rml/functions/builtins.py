...
from fog_rml.algebra.Tuple import EPSILON, _Epsilon, AlgebraicValue
from fog_rml.algebra.Terms import IRI, Literal, BlankNode
from fog_rml.functions.registry import FunctionRegistry
from fog_rml.namespaces import FOG_RML_FUNCTIONS_BASE, XSD_STRING
...
try:
    FunctionRegistry.register(f"{FOG_RML_FUNCTIONS_BASE}concat", concat)
    FunctionRegistry.register(f"{FOG_RML_FUNCTIONS_BASE}toIRI", to_iri)
    FunctionRegistry.register(f"{FOG_RML_FUNCTIONS_BASE}toLiteral", to_literal)
    FunctionRegistry.register(f"{FOG_RML_FUNCTIONS_BASE}toBNode", to_bnode)
    FunctionRegistry.register(f"{FOG_RML_FUNCTIONS_BASE}toLiteralLang", to_literal_lang)
    FunctionRegistry.register(f"{FOG_RML_FUNCTIONS_BASE}percentEncodeComponent", percent_encode_component)
except Exception:
    pass
