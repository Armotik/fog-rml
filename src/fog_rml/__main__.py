...
def load_commands() -> Dict[str, Type[BaseCommand]]:
    """
    Dynamically discover and load command classes from the 'fog_rml.commands' package.
...
def main():
    parser = argparse.ArgumentParser(
        prog="fog-rml",
        description="fog-rml: An Algebra-Based RML Mapper engine."
    )
