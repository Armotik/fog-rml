...
from fog_rml.algebra.Terms import Literal as AlgebraLiteral
...
def load_rows_from_sql_fixture(
	...
	:return: Normalized database rows.
	"""
	strict_mode_flag = os.getenv("FOG_RML_STRICT_REFERENCES")
	if strict_mode_flag is None:
		strict_mode_flag = os.getenv("FOG_RML_STRICT_REFERENCES", "0")
	strict_mode = ("1" == strict_mode_flag)
