...
from fog_rml.namespaces import (
    D2RQ_BASE,
    FNML_BASE,
    FNO_BASE,
    FOG_RML_ERROR_URI,
...
from fog_rml.operators.SourceFactory import SourceFactory
from fog_rml.functions.builtins import to_iri, to_literal, concat, to_bnode, to_literal_lang, percent_encode_component
...
class MappingParser:
    ...
    def _rename_reference_attributes(self, expr: Expression, rename_map: Dict[str, str]) -> None:
        ...
        :return: None
        """
        from fog_rml.expressions.Reference import Reference as ReferenceExpr
        from fog_rml.expressions.FunctionCall import FunctionCall as FunctionCallExpr
    ...
    def _create_ext_expr(self, term_map: Node, default_term_type: str = "Literal") -> Expression:
        ...
        return Constant(AlgebraIRI(FOG_RML_ERROR_URI))
    ...
    def _validated_language_tag(lang_node) -> str:
        ...
        from fog_rml.algebra.Terms import Literal as _AlgebraLiteral
        try:
