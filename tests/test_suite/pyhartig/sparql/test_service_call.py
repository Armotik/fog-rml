...
from pyhartig.sparql.service_call import (
...
def test_service_call_helper_functions_cover_materialization_and_aggregation(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr("pyhartig.mapping.MappingParser.MappingParser", _Parser)
    monkeypatch.setattr("pyhartig.utils.term_utils.term_to_rdflib", lambda value: value)
    ...
    monkeypatch.setattr("pyhartig.sparql.service_call._populate_graph_from_mapping", lambda *_args, **_kwargs: None)
